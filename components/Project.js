        ...
        <>
            <div id='Project' name="Project" className="">
                ...
                <div className="projectOne   w-full items-center flex flex-col md:flex-row justify-center mb-5 md:mb-40">
                    ...
                    <div className="w-90  md:w-145 h-100 md:h-100  flex justify-around flex-col items-center text-justify px-6 "><p><b className='text-3xl text-green-700 '> Home Roots - Real Estate Website</b> <br /><span className='text-lg'>As part of my web development journey, I built a fully responsive Home Roots (Real Estate Website) where users can explore properties, connect with agents, and either buy or sell homes easily. The goal of this project was to simulate a real-world platform and improve my development skills. <br /><b className='font-semibold'>Technologies Used:
                        HTML, CSS,
                ...
                <div className="projectOne w-full items-center flex flex-col md:flex-row justify-center mb-5 md:mb-40">
                    ...
                    <div className="w-90 md:w-140 h-90 md:h-100 flex justify-center flex-col items-center px-4 text-justify "><p><b className='text-3xl  text-green-700'>Netflix Clone </b><br /><span className='text-lg'>I built a Netflix Clone to practice frontend design and layout skills using HTML, CSS, and Tailwind CSS. The aim was to replicate the clean and stylish interface of Netflix while improving my understanding of responsive web design and modern UI structure. <br /> <b className='font-semibold'>Technologies Used:
                        HTML,
